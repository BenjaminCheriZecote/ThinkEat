...
https://thinkeat-production.up.railway.app/
...
L’application est codée en full JS avec React coté front et Node.js/Express coté back. C’est avec Railway que je la déploie, et que j'héberge la base de donnée postgreSQL.
