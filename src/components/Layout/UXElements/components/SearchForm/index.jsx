        ...
        <Form className="section-divForm__Form" action="">
            <fieldset>
                <div className={style.container}>
                    <input onClick={handleClick} defaultChecked={isChecked} className={style.checkbox} type="checkbox"/> 
                    ...
                    <input ref={inputSearchElement} className={style.search_input} placeholder="Rechercher" type="search" onChange={handleChangeSearch}/>
                    </div>
                </div>
            </fieldset>
