            ...
            <fieldset>
                <div className={style.container}>
                    ...
                    <div className={style.mainbox}>
                        ...
                        <input ref={inputSearchElement} className={style.search_input} placeholder="Rechercher" type="search" onChange={handleChangeSearch} aria-label="search into recipes list" id="searchField"/>
                    </div>
                </div>
            </fieldset>
