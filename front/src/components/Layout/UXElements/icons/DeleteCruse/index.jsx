...
const DeleteCruse = ({handleClick, size, id}) => {

    return(
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={`${size}rem`} height={`${size}rem`} viewBox="0 0 48 48" onClick={handleClick} style={{cursor:"pointer"}} data-item-id={id}>
